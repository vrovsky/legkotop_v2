import aboutMePhoto from "../assets/mainpage/aboutMe.png";
  ...
  return (
    <div className="flex lg:flex-row-reverse">
      <img
        src={aboutMePhoto}
        alt="Татьяна Труба"
        className="w-64 lg:w-120 mr-10 object-contain brightness-110"
      />
      <div className="py-4 sm:py-10 px-4 pl-30 text-justify text-[#3c62c9]">
        <h1 className="text-xl sm:text-2xl font-bold mb-6">
          Обо мне и моей методике
        </h1>

        <p className="text-lg sm:text-xl mb-4 pl-4 sm:pl-6">
          Меня зовут <span className="font-semibold">Татьяна Труба</span>. Я
          функциональный терапевт, детский массажист, мама троих дочек и
          основатель пространства{" "}
          <span className="font-semibold">Legko_top</span>. С 2009 года я
          работаю с детьми, изучая самые эффективные подходы к их двигательному
          развитию.
        </p>
        ...
        <div className="bg-gray-100 p-4 ml-5 rounded-lg border-l-4 border-blue-500 mb-4">
          <p className="text-lg sm:text-xl">
            ...
            <span className="font-semibold">"Dvizhenie"</span> в Запорожье.
            Позже начала обучать родителей основам хендлинга и консультировать
            онлайн.
          </p>
        </div>

        <p className="text-lg sm:text-xl mb-4 pl-4 sm:pl-6">
          Моя главная цель – помочь мамам и специалистам понять, как
          поддерживать естественное развитие ребёнка без лишних страхов,
          манипуляций и чрезмерного вмешательства. Рассказываю об этом на своих
          курсах, индивидуальных консультациях и супервизии.
        </p>

        <p className="text-lg sm:text-xl mb-4 pl-4 sm:pl-6 italic">
        ...
        <p className="text-lg sm:text-xl mb-4 pl-4 sm:pl-6">
          ...
          родителей и специалистов по всему миру. Моя цель – сделать
          качественную помощь доступной и изменить культуру отношения к
          двигательному развитию малышей.
        </p>

        <p className="text-lg sm:text-xl font-semibold mb-6 pl-4 sm:pl-6">
