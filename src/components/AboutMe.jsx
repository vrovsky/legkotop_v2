...
export default function AboutMe() {
  return (
    <div className="px-10 py-10">
      <h1 className="text-4xl font-bold mb-6">Обо мне и моей методике</h1>

      <p className="text-2xl mb-4 pl-6">
      ...
      <p className="text-2xl mb-4 pl-6 italic">
      ...
      <p className="text-2xl font-semibold mb-6 pl-6">
